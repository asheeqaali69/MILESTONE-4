interface ResumeData { [key: string]: string; name: string; email: string; phone: string; experience: string; skills: string; profilePicture: string; }

document.addEventListener('DOMContentLoaded', function() { const form = document.getElementById("resumeForm") as HTMLFormElement; const resumeOutput = document.getElementById("resumeOutput") as HTMLDivElement; const profilePictureInput = document.getElementById("profile-picture") as HTMLInputElement; const profilePicturePreview = document.getElementById("profile-picture-preview") as HTMLDivElement; let profilePictureData: string = '';
